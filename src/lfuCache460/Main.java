...
public class Main {
    public static void main(String[] args) {
        ...
        AssertUtils.assertEqualsInteger(-1, cache.get(2));      // 返回 -1 (未找到key 2)
        AssertUtils.assertEqualsInteger(3, cache.get(3));       // 返回 3
        cache.put(4, 4);    // 去除 key 1
        AssertUtils.assertEqualsInteger(-1, cache.get(1));      // 返回 -1 (未找到 key 1)
        AssertUtils.assertEqualsInteger(3, cache.get(3));       // 返回 3
        ...
        AssertUtils.assertEqualsIntegerArray(expect_2, operateQueue(operators_2, operands_2));
        ...
        AssertUtils.assertEqualsIntegerArray(expect_3, operateQueue(operators_3, operands_3));
        ...
        AssertUtils.assertEqualsIntegerArray(expect_4, operateQueue(operators_4, operands_4));


        String[] operators_5 = {"LFUCache","put","get","put","get","get"};
        int[][] operands_5 = {{1},{2,1},{2},{3,2},{2},{3}};
        Integer[] expect_5 = {null,null,1,null,-1,2};
        AssertUtils.assertEqualsIntegerArray(expect_5, operateQueue(operators_5, operands_5));
        ...
        AssertUtils.assertEqualsIntegerArray(expect_6, operateQueue(operators_6, operands_6));
