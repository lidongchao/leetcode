...
public class Main {
    public static void main(String[] args) {
        ...
        AssertUtils.assertEquals(expect_1, solution.canJump(nums_1));

        int[] nums_2 = {3,2,1,0,4};
        boolean expect_2 = false;
        AssertUtils.assertEquals(expect_2, solution.canJump(nums_2));
        ...
        AssertUtils.assertEquals(expect_3, solution.canJump(nums_3));
