...
public class Main {
    public static void main(String[] args) {
        ...
        AssertUtils.assertEquals(expect_1, solution.countCharacters(words_1, chars_1));

        String[] words_2 = {"hello","world","leetcode"};
        String chars_2 = "welldonehoneyr";
        int expect_2 = 10;  // len(hello) + len(world) = 10
        AssertUtils.assertEquals(expect_2, solution.countCharacters(words_2, chars_2));

        String[] words_3 = {"boygirdlggnh"};
        String chars_3 = "usdruypficfbpfbivlrhutcgvyjenlxzeovdyjtgvvfdjzcmikjraspdfp";
        int expect_3 = 0;
        AssertUtils.assertEquals(expect_3, solution.countCharacters(words_3, chars_3));
