...
public class Main {
    public static void main(String[] args) {
        ...
        int[] costs_1 = {2,7,15};
        int expect_1 = 11;
        AssertUtils.assertEquals(expect_1, solution.mincostTickets(days_1, costs_1));
        ...
        int[] costs_2 = {2,7,15};
        int expect_2 = 17;
        AssertUtils.assertEquals(expect_2, solution.mincostTickets(days_2, costs_2));
        ...
        int[] costs_3 = {3,17,57};
        int expect_3 = 170;
        AssertUtils.assertEquals(expect_3, solution.mincostTickets(days_3, costs_3));
    }
}
