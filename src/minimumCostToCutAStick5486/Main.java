...
public class Main {
    public static void main(String[] args) {
        ...
        int expect_1 = 16;
        AssertUtils.assertEqualsInteger(expect_1, solution.minCost(n_1, cuts_1));

        int n_2 = 9;
        int[] cuts_2 = new int[]{5,6,1,4,2};
        int expect_2 = 22;
        AssertUtils.assertEqualsInteger(expect_2, solution.minCost(n_2, cuts_2));

        int n_3 = 13;
        int[] cuts_3 = new int[]{3,12,1,5,9,11,4,8,7,2,6,10};
        int expect_3 = 49;
        AssertUtils.assertEqualsInteger(expect_3, solution.minCost(n_3, cuts_3));
        ...
        AssertUtils.assertEqualsInteger(expect_4, solution.minCost(n_4, cuts_4));
